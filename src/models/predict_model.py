...
def plot_damage_indices(healthy_indices, damaged_indices, figsize=(12, 6)):
    ...
    plt.title('Correlação não linear entre DI', fontsize=18, weight='bold')
...
def main():
    ...
    anomalous_path_5pc = r'/Users/home/Documents/github/convolutional_autoencoder/data/processed/npy/acc_vehicle_data_dof_5_10pc.npy'
    anomalous_path_10pc = r'/Users/home/Documents/github/convolutional_autoencoder/data/processed/npy/acc_vehicle_data_dof_5_20pc.npy'
    ...
    conditions = np.concatenate([
        ...
        np.full(len(damaged_di_5pc), '10% Damage'),
        np.full(len(damaged_di_10pc), '20% Damage')
    ])
    ...
    conditions_order = ['Healthy', '10% Damage', '20% Damage']
